...
fun AustriaQuizScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            val years = listOf(
                976,    // バーベンベルク家によるオーストリア辺境伯領の成立
                1278,   // ハプスブルク家がオーストリアを支配開始（ルドルフ1世の勝利）
                1438,   // ハプスブルク家が神聖ローマ皇帝位を世襲化
                1526,   // モハーチの戦い、ボヘミアとハンガリーの支配を開始
                1556,   // 神聖ローマ皇帝カール5世の退位、オーストリア系ハプスブルクと分離
                1618,   // 三十年戦争の始まり
                1683,   // 第二次ウィーン包囲戦、オスマン帝国を撃退
                1740,   // マリア・テレジアの即位、オーストリア継承戦争勃発
                1804,   // オーストリア帝国の成立
                1806,   // 神聖ローマ帝国の解体
                1867,   // オーストリア＝ハンガリー帝国成立（アウスグライヒ）
                1914,   // 第一次世界大戦勃発（サラエボ事件）
                1918,   // オーストリア＝ハンガリー帝国崩壊、オーストリア共和国成立
                1938,   // アンシュルス（ナチス・ドイツによる併合）
                1955,   // オーストリア国家条約、永世中立国として独立回復
            )
